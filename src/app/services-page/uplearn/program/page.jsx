...
const page = () => {
  return (
    <div className="relative w-full max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-green-600 to-green-800 text-white text-center py-6">
        <h1 className="text-3xl font-bold">  Why Uplearning is Crucial in Trading</h1>
        <p className="text-lg">India's Premier Rotary-Wing Training & Career Launchpad</p>
      </div>
      ...
      <div className="absolute bottom-4 left-4">
        <button className="bg-red-500 text-white font-bold py-2 px-4 rounded-full flex items-center">
          <span className="mr-2">🔔</span> 2 Issues
        </button>
      </div>
    </div>
  );

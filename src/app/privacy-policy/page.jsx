  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-gray-100 flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-7xl mb-8">
        <div className="bg-gradient-to-r from-blue-950 to-blue-900 p-8 rounded-lg shadow-lg text-center text-white animate-fade-in">
      ...
      <div className="w-full max-w-7xl space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Introduction */}
          <div className="bg-white p-6 rounded-lg shadow-lg text-gray-800 transform transition-transform duration-300 hover:scale-105 animate-fade-in">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg text-gray-800 transform transition-transform duration-300 hover:scale-105 animate-fade-in md:col-span-2">
            <div className="flex items-center mb-4">
              <span className="text-2xl mr-3">📅</span>

...
const services = [
  {
    ...
    icon: "/up1.png", // Replace with your icon path
  },
  {
    title: "Why Uplearning is Crucial in Trading",
    icon: "/up2.png", // Replace with your icon path
  },
  {
    title: "Success Stories: Real Results from Uplearning",
    icon: "/up3.png", // Replace with your icon path
  },
  {
    title: "5 Common Mistakes New Forex Traders Make",
    icon: "/up4.png", // Replace with your icon path
  },
];
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service, idx) => (
            <div
              key={idx}
              className="bg-[#1a1a1a] rounded-xl p-6 flex flex-col items-center justify-center hover:scale-105 transition duration-300 border border-gray-700"
            >
              <Image
                src={service.icon}
                alt={service.title}

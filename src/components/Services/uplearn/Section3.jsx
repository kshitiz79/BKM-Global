...
export function Section3() {
  return (
    <section className="bg-gradient-to-b from-white to-gray-50 text-gray-900 py-20 px-6">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-md mb-6">FAQs</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {/* Box 1 */}
          <div className="flex items-start gap-4 bg-white rounded-lg p-6 border border-gray-200 shadow-lg">
            <span className="text-blue-600 text-xl pt-1">
              <FaCheck />
            </span>
            <div>
              <h3 className="font-bold text-lg mb-2 text-gray-900">What is the Uplearn program?</h3>
              <p className="text-gray-700">
                The Uplearn program is designed to help traders and investors let go of outdated practices and adopt new strategies that align with current market dynamics. It combines personalized assessments, educational resources, hands-on training, and continuous support to ensure your success.
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4 bg-white rounded-lg p-6 border border-gray-200 shadow-lg">
            ...
            <div>
              <h3 className="font-bold text-lg mb-2 text-gray-900">Who can benefit from the Uplearn program?</h3>
              <p className="text-gray-700">
          ...
          <div className="flex items-start gap-4 bg-white rounded-lg p-6 border border-gray-200 shadow-lg">
            ...
            <div>
              <h3 className="font-bold text-lg mb-2 text-gray-900">How long does the Uplearn program take?</h3>
              <p className="text-gray-700">
          ...
          <div className="flex items-start gap-4 bg-white rounded-lg p-6 border border-gray-200 shadow-lg">
            ...
            <div>
              <h3 className="font-bold text-lg mb-2 text-gray-900">How do I get started with the Uplearn program?</h3>
              <p className="text-gray-700">

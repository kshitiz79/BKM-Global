...
export function ShootingStarsAndStarsBackgroundDemo() {
  return (
    <div className="mx-auto py-12 flex flex-col justify-center bg-black relative w-full">
      <h2 className="relative flex-col md:flex-row z-10 text-3xl md:text-4xl max-w-7xl mx-auto tracking-tight font-light bg-clip-text text-white flex items-center gap-2 md:gap-8 text-center md:text-left">
        BKM Global: Elevating Your Investment Experience
      </h2>
      <p className="relative flex-col md:flex-row z-10 text-lg md:text-xl max-w-5xl mx-auto tracking-tight font-light  text-white flex items-center gap-2 mt-4 px-8 text-justify">

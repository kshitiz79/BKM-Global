...
export function ShootingStarsAndStarsBackgroundDemo() {
  ...
  ref={ref}
  animate={controls}
  initial={{ opacity: 0, x: -300, y: 300 }} // More dramatic bottom-left offset
  transition={{ duration: 1.5, ease: "easeOut" }}
  className="app-container relative w-full mx-auto overflow-hidden rounded-tr-4xl bg-white shadow-2xl py-12 px-4 sm:px-6 md:px-12"
>

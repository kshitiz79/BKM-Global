...
const Services = () => {
  return (
    <div className="w-full py-16 bg-gradient-to-b from-white to-gray-50 dark:from-neutral-950 dark:to-neutral-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-20">
          {serviceData.map((service, index) => (
            <motion.div
              ...
              className="bg-white dark:bg-neutral-800 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
            >
        ...
        <motion.div 
          ...
          className="bg-blue-50 dark:bg-neutral-800 rounded-2xl p-8 md:p-12 max-w-7xl mx-auto"
        >

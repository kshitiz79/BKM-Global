  ...
  const data = [
    {
      ...
      content: (
        <div>
          <p
            className="text-neutral-900 dark:text-neutral-200 text-xl md:text-xl font-normal mb-8 text-justify">
    ...
    },
    {
      ...
      content: (
        <div>
          <p
            className="text-neutral-900 dark:text-neutral-950 text-xl md:text-xl font-normal mb-8 text-justify">
          ...
          <p
            className="text-neutral-900 dark:text-neutral-900 text-xl md:text-xl font-normal mb-8 text-justify">
    ...
    },
    {
      ...
      content: (
        <div>
          <p
            className="text-neutral-900 dark:text-neutral-900 text-xl md:text-xl font-normal mb-4 text-justify">
            Looking ahead, we are excited about the future of BKM Global. 
          </p>
          <div className="mb-8">
            <div
              className="flex gap-2 items-center text-neutral-900 dark:text-neutral-900 text-xs md:text-xl text-justify">
            ...
            <div
              className="flex gap-2 items-center text-neutral-900 dark:text-neutral-900 text-lg md:text-xl text-justify">
